...
Scene.prototype.drawRobots = function () {
    ...
    for (var r = 0; r < this.numprogs; r++) {
        ...
        this.rCtx.quadraticCurveTo(
            this.robots[r].geom.x + this.robots[r].geom.w,
            this.robots[r].geom.y,
            this.robots[r].geom.x + this.robots[r].geom.w,
            this.robots[r].geom.y + radius
        );
        this.rCtx.lineTo(this.robots[r].geom.x + this.robots[r].geom.w, this.robots[r].geom.y + this.robots[r].geom.h - radius);
        this.rCtx.quadraticCurveTo(
            this.robots[r].geom.x + this.robots[r].geom.w,
            this.robots[r].geom.y + this.robots[r].geom.h,
            this.robots[r].geom.x + this.robots[r].geom.w - radius,
            this.robots[r].geom.y + this.robots[r].geom.h
        );
        this.rCtx.lineTo(this.robots[r].geom.x + radius, this.robots[r].geom.y + this.robots[r].geom.h);
        this.rCtx.quadraticCurveTo(
            this.robots[r].geom.x,
            this.robots[r].geom.y + this.robots[r].geom.h,
            this.robots[r].geom.x,
            this.robots[r].geom.y + this.robots[r].geom.h - radius
        );
                ...
                if (touchSensor.value === 0) {
                    ...
                    if (personalObstacleList[i].form !== 'circle') {
                        ...
                        for (var k = 0; k < obstacleLines.length; k++) {
                            ...
                            if (
                                SIMATH.sqr(touchSensor.rx - p.x) + SIMATH.sqr(touchSensor.ry - p.y) <
                                ...
                                if (
                                    SIMATH.sqr(this.robots[r].backMiddle.rx - p.x) + SIMATH.sqr(this.robots[r].backMiddle.ry - p.y) <
                                    SIM.getDt() * (personalObstacleList[i].tolerance + thisTolerance)
                                ) {
                                    this.robots[r].backLeft.bumped = true;
                                    this.robots[r].backRight.bumped = true;
                    ...
                    if (personalObstacleList[i].form !== 'circle') {
                        ...
                        for (var k = 0; k < obstacleLines.length; k++) {
                            for (var j = 0; j < uA.length; j++) {
                                ...
                                if (interPoint) {
                                    var dis = Math.sqrt(
                                        (interPoint.x - ultraSensors[s].rx) * (interPoint.x - ultraSensors[s].rx) +
